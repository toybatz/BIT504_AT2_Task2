...
public class Cell {
    ...
    public Cell(int row, int col) {
        ...
        // Set the row and column for this cell
        this.row = row;
        this.col = col;

        // TODO: call the method that sets the cell content to EMPTY
        // Clear the content of the cell to set it to empty
        clear();
    }
    ...
    public void paint(Graphics g) {
        ...
        if (content == Player.Cross) {
            ...
            // Draw a blue "O" for Player.Nought
    ...
    public void clear() {
        ...
        // Set the cell content to Player.Empty

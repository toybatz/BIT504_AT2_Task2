...
public class Board {
    ...
    public Board() {
        ...
        // Initialize the 2D array for cells
   cells = new Cell[GameMain.ROWS][GameMain.COLS];
        
        for (int row = 0; row < GameMain.ROWS; ++row) {
            for (int col = 0; col < GameMain.COLS; ++col) {
                // Initialize each cell with its row and column
                // Create a new Cell instance for each position
...
return true;
        ...
        // Check if the player has 3 marks in the selected column
